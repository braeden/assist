 ...
 * adb shell am broadcast -a com.wisp.DEBUG_INTERRUPT
 * ```
 *
...
class DebugRunReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_DEBUG_RUN = "com.wisp.DEBUG_RUN"
        const val ACTION_DEBUG_INTERRUPT = "com.wisp.DEBUG_INTERRUPT"
    }
}
