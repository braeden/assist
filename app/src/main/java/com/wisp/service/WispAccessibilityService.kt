 ...
 */
@AndroidEntryPoint
class WispAccessibilityService : AccessibilityService() {
    ...
    override fun onServiceConnected() {
        ...
        Log.i(TAG, "WispAccessibilityService connected")
    }
    ...
    companion object {
        private const val TAG = "WispA11yService"
        const val ACTION_DEBUG_DUMP = "com.wisp.DEBUG_DUMP_SCREEN"

        /** Process-wide handle to the connected service, or null when disabled. */
        @Volatile
        var instance: WispAccessibilityService? = null
            private set
    }
}
