...
/**
 * [DeviceController] backed by the live [WispAccessibilityService]. Owns the single
...
class DefaultDeviceController(
    ...
    private fun service(): WispAccessibilityService? = WispAccessibilityService.instance
